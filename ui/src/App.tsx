...
export default function App() {
  ...
  useEffect(() => {
    if (window.racenet) {
      ...
      // Browser dev mode — use mock data with a slow ticker to simulate updates
  ...
  return (
    <div className="h-full flex flex-col bg-bg overflow-hidden">
      ...
      >
        ...
        {session.lap !== null && (
          <span className="font-heading font-bold text-sm text-fg/70">
            LAP {session.lap}
          </span>
        )}
        <span className="ml-auto text-[10px] font-body text-muted-fg tabular-nums">
          {ageLabel}
        </span>
        {!payload && (
