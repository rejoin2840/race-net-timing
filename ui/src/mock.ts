...
const noNet = {
  ...
  catchInLaps: null, strategyNote: null, netUpdatedAt: null,
  pitEvents: [],
};
  ...
  classes: [
    {
      ...
      rows: [
        { car: '10', pos: 1, driver: 'F. Albuquerque', team: 'Wayne Taylor Racing',     gapMs: 0,      laps: 47, trackStatus: 'TRACK',   stops: 2, isRunning: true,
          ...
          projectedFinish: 1, fuelDue: null, catching: null, catchInLaps: null, strategyNote: null, netUpdatedAt: new Date().toISOString(),
        ...
        { car: '31', pos: 2, driver: 'P. Derani',      team: 'Whelen Engineering',      gapMs: 12345,  laps: 47, trackStatus: 'TRACK',   stops: 2, isRunning: true,
          ...
          projectedFinish: 3, fuelDue: null, catching: null, catchInLaps: null, strategyNote: 'undercut #10 (it pits sooner)', netUpdatedAt: new Date().toISOString(),
        ...
        { car: '7',  pos: 3, driver: 'M. Conway',      team: 'Acura ARX-06',            gapMs: 34012,  laps: 47, trackStatus: 'BOX',     stops: 1, isRunning: false,
          ...
          projectedFinish: 2, fuelDue: 'due', catching: '10', catchInLaps: 4.2, strategyNote: null, netUpdatedAt: new Date().toISOString(),
        ...
        { car: '60', pos: 4, driver: 'O. Jarvis',      team: 'Meyer Shank Racing',      gapMs: 56789,  laps: 46, trackStatus: 'TRACK',   stops: 2, isRunning: true,
          ...
          projectedFinish: 4, fuelDue: null, catching: null, catchInLaps: null, strategyNote: null, netUpdatedAt: new Date().toISOString(),
