...
export const buildMockPayload = (): RowsPayload => ({
  ...
  classes: [
    ...
    },
    {
      code: 'GTD',
      rows: [
        { car: '57', pos: 1, driver: 'B. Sellers', team: 'Winward Racing', gapMs: 0,     laps: 42, trackStatus: 'TRACK', stops: 3, isRunning: true, ...noNet, ...noLapData, pitEvents: [] },
        { car: '44', pos: 2, driver: 'J. Potter',  team: 'Magnus Racing',  gapMs: 15678, laps: 42, trackStatus: 'TRACK', stops: 3, isRunning: true, ...noNet, ...noLapData, pitEvents: [] },
      ],
    },
  ],
  updatedAt: Date.now(),
